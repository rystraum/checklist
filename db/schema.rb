...
ActiveRecord::Schema.define(:version => 20120827044602) do
  ...
  add_index "inspectors", ["reset_password_token"], :name => "index_inspectors_on_reset_password_token", :unique => true
